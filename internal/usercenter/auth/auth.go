...
//go:generate mockgen -self_package github.com/costa92/k8s-krm-go/internal/usercenter/auth -destination mock_auth.go -package auth github.com/costa92/k8s-krm-go/internal/usercenter/auth AuthProvider,AuthzInterface,AuthnInterface
